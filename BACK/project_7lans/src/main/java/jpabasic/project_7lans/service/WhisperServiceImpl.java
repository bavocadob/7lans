...
public class WhisperServiceImpl implements WhisperService{
    ...
    public void saveWhisper(ChildVolunteerRelation relation, Member writer, String contnet){
        Whisper whisper = Whisper.createWhisper(relation, contnet, writer);
        whisperRepository.save(whisper);
    }

    public List<Whisper> findWhispers(ChildVolunteerRelation relation){
        return whisperRepository.findByRelation(relation);
    }

    public List<Whisper> findUnreadWhispers(ChildVolunteerRelation relation){
        List<Whisper> whispers = whisperRepository.findByRelation(relation);
